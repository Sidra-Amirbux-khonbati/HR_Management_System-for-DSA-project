...
This project is a Java-based HR Management System developed using Java Swing. It provides a graphical user interface to manage employee records and demonstrates basic Data Structures and Algorithms concepts.
...
3. Sorting Module (Insertion Sort)
...
Run the HR_Management_System.java file
Use the buttons in the GUI to perform operations
